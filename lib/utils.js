...
export function getAssertionNames() {
 ...
 * @returns {boolean}
 */
export function isAsyncCallExpression(callExpressionNode, assertVar) {
    if (!assertVar) {
        assertVar = "assert";
    }
 ...
 * @returns {boolean}
 */
export function isStop(calleeNode) {
    let result = false;
 ...
 * @returns {boolean}
 */
export function isStart(calleeNode) {
    let result = false;
 ...
 * @returns {boolean}
 */
export function isTest(calleeNode) {
    let result = false;
 ...
 * @returns {boolean}
 */
export function isModule(calleeNode) {
    let result = false;
 ...
 * @returns {boolean}
 */
export function isModuleHookPropertyKey(identifierNode) {
    return (
        identifierNode &&
 ...
 * @returns {boolean}
 */
export function isAsyncTest(calleeNode) {
    let result = false;
 ...
 * @returns {boolean}
 */
export function isOnly(calleeNode) {
 ...
 * @returns {boolean}
 */
export function isSkip(calleeNode) {
 ...
 * @returns {string | null}
 */
export function getAssertContextNameForTest(argumentsNodes) {
 ...
 * @returns {string | null}
 */
export function getAssertContextName(functionExpr) {
    let result = null;
 ...
 * @returns {boolean}
 */
export function isAssertion(calleeNode, assertVar) {
 ...
 * @returns {number[]}
 */
export function getAllowedArities(calleeNode, assertVar) {
 ...
 * @returns {boolean}
 */
export function isComparativeAssertion(calleeNode, assertVar) {
    const assertionMetadata = getAssertionMetadata(calleeNode, assertVar);
 ...
 * @returns {boolean}
 */
export function shouldCompareActualFirst(calleeNode, assertVar) {
    const assertionMetadata = getAssertionMetadata(calleeNode, assertVar);
    if (!assertionMetadata) {
        return false;
    }
 ...
 */
export function createAssertionCheck(assertions, errorMessageConfig) {
    /**
